...
public class MediaVolumeService extends NonstopIntentService {
    ...
    private final static String MEDIA_VOLUME_NOTIFICATION_CHANNEL_ID = "MediaVolumeControlNotificationChannelID";
    private final static String MEDIA_VOLUME_NOTIFICATION_CHANNEL_NAME = "MediaVolumeControl";
    ...
    private BroadcastReceiver systemChangedBroadcastReceiver;
    ...
    {
        this.registerSystemBroadcastReceiver();
    }

    private void unregisterBroadcastReceivers()
    {
        this.unregisterReceiver(this.systemChangedBroadcastReceiver );
    }

    private void registerSystemBroadcastReceiver()
    {
        IntentFilter filter = new IntentFilter();
        filter.addAction(SystemChangedBroadcastReceiver.VOLUME_CHANGED_ACTION);
        filter.setPriority(100);
        this.systemChangedBroadcastReceiver = new SystemChangedBroadcastReceiver();
        registerReceiver(this.systemChangedBroadcastReceiver, filter);
    }
    ...
    private Notification createMediaVolumeNotification() {
        ...
        NotificationChannel notificationChannel = new NotificationChannel(MEDIA_VOLUME_NOTIFICATION_CHANNEL_ID,
                MEDIA_VOLUME_NOTIFICATION_CHANNEL_NAME, NotificationManager.IMPORTANCE_HIGH);
        notificationChannel.setLockscreenVisibility(Notification.VISIBILITY_PUBLIC);
        NotificationManager manager = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
        manager.createNotificationChannel(notificationChannel);

        NotificationCompat.Builder builder = new NotificationCompat.Builder(
                this, MEDIA_VOLUME_NOTIFICATION_CHANNEL_ID)
                // Set Icon
